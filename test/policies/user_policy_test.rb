    ...
    %i[superadmin admin].each do |user_role|
      context "for #{user_role} users" do
        ...
        should "be permitted" do
          assert permit?(@current_user, @current_user, :grant_signin_permission)
        end
      end
    end
    ...
    %i[super_organisation_admin organisation_admin normal].each do |user_role|
      context "for #{user_role} users" do
        ...
        should "be forbidden" do
          assert forbid?(@current_user, @current_user, :grant_signin_permission)
        end
      end
    end
  end
  ...
  context "#remove_signin_permission?" do
    %i[superadmin admin].each do |user_role|
      context "for #{user_role} users" do
        ...
        should "be permitted" do
          assert permit?(@current_user, @current_user, :remove_signin_permission)
        end
      end
    end
    ...
    %i[super_organisation_admin organisation_admin normal].each do |user_role|
      context "for #{user_role} users" do
        ...
        should "be forbidden" do
          assert forbid?(@current_user, @current_user, :remove_signin_permission)
        end
      end
    end
  end
