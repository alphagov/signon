class SessionsController < Devise::SessionsController
  ...
  if Devise::VERSION == "3.1.0"
    ...
    # timeout. In Devise 3.0.4, it's the only one defined as an anonymous Proc,
    ...
    callback_checks = [
      ...
      # FIXME: per_key doesn't work any more, find an alternative
    ...
    raise "This hack only applies to Devise 3.0.4: aborting"
  end
